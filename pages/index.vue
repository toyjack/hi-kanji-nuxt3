  ...
  <div
    ...
    <div class="flex flex-col items-center justify-between h-full">
      ...
      <div class="flex flex-row mb-auto pt-4 gap-2">
        ...
        <button @click="move"
          class="p-2 mb-auto text-white bg-blue-500 rounded px-4 py-2 hover:bg-white hover:text-black duration-300">{{ $t('button.search') }}</button>
      </div>
      ...
      <div class="px-1 md:p-2 self-end items-end bg-black opacity-20 rounded ">
        <p class="text-xs md:text-base text-white underline text-right"><a
            href="https://clioimg.hi.u-tokyo.ac.jp/viewer/view/idata/000/0073/10/8/00000005?m=limit&n=20" target="blank">{{$t('index.bgImage')}}</a></p>
      </div>
    </div>
  </div>
